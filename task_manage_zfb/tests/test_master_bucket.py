...
from task_manage_zfb.master_bucket import MasterBucket, MasterTask, MasterBucketResult, MasterTaskResult
from task_manage_zfb.worker_bucket import Bucket, Task, TaskResult
